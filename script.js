...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // CÓDIGO ATUALIZADO (DEPOIS) - Com efeito de encolher
    ...
    window.addEventListener('scroll', function() {
        ...
        if (window.pageYOffset > scrollThreshold) {
            // Adiciona a classe .scrolled se a rolagem passou do limite
            header.classList.add('scrolled');
        } else {
            // Remove a classe .scrolled se a rolagem voltou ao topo
